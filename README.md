...
**También se puede encontrar un pequeño resumen de la base de datos que se esta usando en el archivo situado en la raiz del proyecto llamado "Importacion de Neo4j.md".**
